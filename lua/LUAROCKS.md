...
- rockspec: `lua/gmeow-gts-1.0.0rc1-1.rockspec`
- LuaRocks package: `gmeow-gts`
- LuaRocks version: `1.0.0rc1-1`
- source tag: `lua-v1.0.0rc1`
...
luarocks lint lua/gmeow-gts-1.0.0rc1-1.rockspec
luarocks make lua/gmeow-gts-1.0.0rc1-1.rockspec --tree /tmp/gts-luarocks
luarocks --tree /tmp/gts-luarocks pack gmeow-gts 1.0.0rc1-1
...
```sh
git tag -s lua-v1.0.0rc1
git push origin lua-v1.0.0rc1
```
...
```sh
luarocks upload lua/gmeow-gts-1.0.0rc1-1.rockspec --api-key="$LUAROCKS_API_KEY"
```
