...
# Liste de contrôle et ensemble d'artéfacts GTS v1.0-rc1
...
Cette liste de contrôle transforme le chemin de version v1.0-rc1 dans [`GTS-GOVERNANCE.md`](./GTS-GOVERNANCE.md) en un enregistrement de candidat à la version exécutable. Copiez les sections non cochées dans le ticket de version ou conservez une copie remplie comme artéfact de version. Ne modifiez pas le manifeste de vecteurs validé pour marquer une révision de version ; générez plutôt l'artéfact marqué décrit ci-dessous.
...
## 6. Contrôles du corpus et de conformité
...
## 7. Contrôles de sécurité et de chaîne d’approvisionnement
...
## 11. Vérification des artéfacts publiés
