...
|---|---|---|
| Paper outline and publication draft | Track as a docs/research issue or project item. Current draft: [`GTS-PAPER-DRAFT.md`](./GTS-PAPER-DRAFT.md). Reuse the standalone framing and conformance results. | Describes and motivates GTS; does not define normative behavior. |
